...
export default function AdminDashboard() {
  ...
  const quickActions = [
    { title: 'Gerenciar Planos', icon: Wifi, href: '/admin/planos', color: 'text-blue-600 bg-blue-50' },
    { title: 'Ver Formulários', icon: FileText, href: '/admin/formularios', color: 'text-purple-600 bg-purple-50' },
    { title: 'Personalização', icon: Settings, href: '/admin/personalizacao', color: 'text-green-600 bg-green-50' },
    { title: 'Gerenciar Usuários', icon: Users, href: '/admin/usuarios', color: 'text-orange-600 bg-orange-50' }
  ];
